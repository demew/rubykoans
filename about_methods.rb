...
class AboutMethods < EdgeCase::Koan
  ...
  # The code does freak out here if you don't comment it out before running
  # prior test before first success 
  ...
  def test_calling_private_methods_with_an_explicit_receiver
    # because it is a private method and not a class method?
