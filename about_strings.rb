...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # Like python - appending to a pre-existing obj versus new obj?
  end
  ...
  def test_single_quoted_strings_do_not_interpolate
    ...
    # Better: assert_equal true, string != "The value is #{value}"
  end
  ...
  # This was skipped because I am in 1.8
